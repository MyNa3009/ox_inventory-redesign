...
const WeightBar: React.FC<{ percent: number; durability?: boolean }> = ({ percent, durability }) => {
  const COLORS = {
    primaryColor: hexToRgbArray(UIConfig.durability.low),
    secondColor: hexToRgbArray(UIConfig.durability.high),
    accentColor: hexToRgbArray(UIConfig.durability.medium),
  };
